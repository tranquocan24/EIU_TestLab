              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Tên đề thi</th>
                    ...
                    <th className="text-left py-3 px-4 font-semibold text-gray-700">Câu hỏi</th>
        ...
        <Card>
          <CardContent className="p-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Không tìm thấy đề thi</h3>
